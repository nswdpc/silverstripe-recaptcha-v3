...
use NSWDPC\SpamProtection\Tests\Support\TestRecaptchaV3FormWithRuleController;
...
class RecaptchaV3RuleFunctionalTest extends FunctionalTest
{
    ...
    public function testFormSubmissionWithRule()
    {
        ...
        $this->assertInstanceOf(Verifier::class, $field->getVerifier(), "Field verifier is a Verifier");
